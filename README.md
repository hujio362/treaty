...
|サークルオープン機能|ログインユーザーが任意のジャンルに基づいたサークルをオープンすることができる|ークル名、人数制限、説明文、ジャンル、写真を設定できる|ログインユーザーどうしでサークルを作り、サークル内のみに表示される投稿などを行う|
|サークル編集機能|一度オープンしたサークルを編集する|サークルのオーナーのみ編集できる||	
|サークル削除機能|一度オープンしたサークルを削除する|サークルのオーナーのみ削除できる||
|サークル参加機能|オープンされたサークルに参加する|サークルトップページから参加することができる。オーナーユーザーは参加することができない|自分の趣向に合うサークルを見つけたら、サークルに参加することで、サークル内のユーザーと交流することができる|	
